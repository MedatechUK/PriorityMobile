...
#End Region
    ...
    Public Overrides Sub TableSettings()
        ...
        CtrlTable.RecordsSQL = "select WARHSNAME, LOCNAME , CUSTOMERS.CUSTNAME, SERIAL.SERIALNAME, ACT.ACTNAME, dbo.REALQUANT(BALANCE) as BALANCE, dbo.REALQUANT(BALANCE) AS CQUANT " & _
