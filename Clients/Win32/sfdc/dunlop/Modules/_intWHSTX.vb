...
#Region "Process Entry"
    ...
    Private Sub ProcessEntry_INTERWHTX(ByVal ctrl As w32SFDCData.ctrlText)
        ...
        Try
            If Len(Val("WARHS")) > 0 And Len(Val("LOCNAME")) > 0 And Len(Val("STATUS")) > 0 And Len(Val("_PARTNAME")) > 0 And Len(Val("_SERIALNAME")) > 0 Then
                ...
                CtrlTable.el(ColNo("_AVAILIBLE")).NSInvoke(sql)
            End If
        Catch
        End Try
        ...
        With CtrlTable
            ...
            .EnableToolbar( _
                ...
                Len(Val("STATUS")) > 0), _
                .btnEnabled(w32SFDCData.CtrlTable.tButton.btnEdit), _
                .btnEnabled(w32SFDCData.CtrlTable.tButton.btnCopy), _
                .btnEnabled(w32SFDCData.CtrlTable.tButton.btnDelete), _
                .btnEnabled(w32SFDCData.CtrlTable.tButton.btnPost) _
            )
    ...
    Private Sub ProcessEntry_PUTAWAY(ByVal ctrl As w32SFDCData.ctrlText)
    ...
    Private Sub ProcessEntry_CHSTATUS(ByVal ctrl As w32SFDCData.ctrlText)
...
#End Region
    ...
    Public Overrides Sub BeginAdd()
        Select Case Argument("TXTYPE")
            Case "INTERWHTX"
                ...
                CtrlTable.mCol(ColNo("_SERIALNAME")).ctrlEnabled = False
                CtrlTable.mCol(ColNo("_AVAILIBLE")).ctrlEnabled = False
    ...
    Public Overrides Sub BeginEdit()
        Select Case Argument("TXTYPE")
            Case "INTERWHTX"
                CtrlTable.mCol(ColNo("_PARTNAME")).ctrlEnabled = True
                CtrlTable.mCol(ColNo("_SERIALNAME")).ctrlEnabled = True
                CtrlTable.mCol(ColNo("_AVAILIBLE")).ctrlEnabled = False
                CtrlTable.mCol(ColNo("_TQUANT")).ctrlEnabled = True
                CtrlTable.mCol(ColNo("_TOWARHS")).ctrlEnabled = True
                CtrlTable.mCol(ColNo("_TOLOCNAME")).ctrlEnabled = True
