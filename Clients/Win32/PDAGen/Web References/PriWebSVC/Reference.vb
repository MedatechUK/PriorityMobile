...
Namespace PriWebSVC
    ...
    Partial Public Class Service
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.PDAGenerator.My.MySettings.Default.PDAGenerator_PriWebSVC_Service
        ...
        '''<remarks/>
        Public Overloads Sub GetDataAsync(ByVal SQL As String, ByVal Env As String)
            Me.GetDataAsync(SQL, Env, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub GetDataAsync(ByVal SQL As String, ByVal Env As String, ByVal userState As Object)
            If (Me.GetDataOperationCompleted Is Nothing) Then
                Me.GetDataOperationCompleted = AddressOf Me.OnGetDataOperationCompleted
            End If
            Me.InvokeAsync("GetData", New Object() {SQL, Env}, Me.GetDataOperationCompleted, userState)
        End Sub
