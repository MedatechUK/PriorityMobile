...
Module BoExchange
    Sub Main()
        ...
        Dim pathArg As String = ""
        Dim lcArg As String = ""
        For Each arg As String In args
            If InStr(arg, ".xml") Then
                pathArg = arg
            ElseIf arg.Length = 12 And Not InStr(arg, ".exe") Then
                lcArg = arg
            End If
        Next
        If pathArg = "" Then
        ...
        End If
        '#### licensing ####
        Dim lc As New License(System.Reflection.Assembly.GetExecutingAssembly.ToString, lcArg)
        If Not lc.isValid Then
            Exit Sub
        End If

        Dim url As String = urlBuilder()
        If urlCheck(url) Then
            xmlParse(url, pathArg)
        Else
            End
        End If
        Exit Sub
