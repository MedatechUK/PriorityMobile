...
#Region "Initialisation"
    ...
    Public Sub New(Optional ByRef App As PDAOnBoardData.BaseForm = Nothing)
        ...
        With Me
            .Name = "Cancel"
            .ConQuery = "Select * from ZPDA_CALLCANCEL WHERE USERNAME = '" & My.Settings.Username & "' "
            .Column(0) = "DOCNO"
        End With
...
#Region "Must Override Subs"
    ...
    Public Overrides Sub ChangeSettings()
        Me.ConQuery = "Select * from ZPDA_CALLCANCEL WHERE USERNAME = '" & My.Settings.Username & "' "
    End Sub
    ...
    Public Overrides Sub SyncNewData()
        ...
        Try
            ...
            For i As Integer = 0 To UBound(tempArray, 2)
                ' If call exists
                Dim id As Integer = ar.InArray(_App.rss(o.ServiceCall).thisArray, 0, tempArray(0, i))
                If id > -1 Then
