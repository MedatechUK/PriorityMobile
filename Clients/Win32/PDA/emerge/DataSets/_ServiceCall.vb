...
#Region "Initialisation"
    ...
    Public Sub New(Optional ByRef App As PDAOnBoardData.BaseForm = Nothing)
        ...
        With Me
            .Name = "ServiceCall"
            .ConQuery = "SELECT * FROM V_SERVCALL WHERE USERLOGIN = '" & My.Settings.Username & "' "
            .Column(0) = "DOCNO"
            .Column(1) = "DATEOPENED"
            .Column(2) = "PDATE"
            .Column(3) = "USERLOGIN"
...
#Region "Must Override Subs"
    ...
    Public Overrides Sub ChangeSettings()
        Me.ConQuery = "SELECT * FROM V_SERVCALL WHERE USERLOGIN = '" & My.Settings.Username & "' "
    End Sub
