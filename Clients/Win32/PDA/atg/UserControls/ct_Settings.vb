...
Public Class ct_Settings
    ...
    Public Sub init()
        ...
        Me.txt_ServiceURL.Text = My.Settings.PDA_priwebsvc_Service
    ...
    Public Function VerifySettings() As Boolean
        ...
        If Not regex_WebService.IsMatch(My.Settings.PDA_priwebsvc_Service) Then
            ret = False
        End If
    ...
    Public Function SaveSettings() As Boolean
        ...
        If regex_WebService.IsMatch(Me.txt_ServiceURL.Text) Then
            'My.Settings.PDA_priwebsvc_Service = Me.txt_ServiceURL.Text
        Else
