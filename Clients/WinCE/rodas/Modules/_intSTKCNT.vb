...
#End Region
    ...
    Public Overrides Sub FormSettings()
        ...
        With field
            ...
            .SQLValidation = "SELECT top 1 WARHSNAME FROM WAREHOUSES WHERE WARHSNAME = '%ME%' AND INACTIVE <> 'Y'"
            .Data = ""      '******** Barcoded field '*******
        ...
        With field
            ...
            .SQLValidation = "SELECT top 1 LOCNAME FROM WAREHOUSES WHERE LOCNAME = '%ME%' AND WARHSNAME = '%WARHS%' AND INACTIVE <> 'Y'"
            .Data = ""      '******** Barcoded field '*******
            .AltEntry = ctrlText.tAltCtrlStyle.ctList 'ctNone 'ctKeyb 
            .ctrlEnabled = True
        End With
