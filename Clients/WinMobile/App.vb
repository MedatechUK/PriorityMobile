...
Public Class AppForm
    ...
    Dim CallerAppexit As Boolean = False
...
#Region "Initialisation and Finalisation"
    ...
    Private Sub AppForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        mySettings = New cfOnBoardData.cfSettings
        mySettings.Load()

        ' Load the picture into a Bitmap.
        Dim bm As New Bitmap(myBasePath & "\logo.BMP")
        ...
        AddRSS(o.ServiceCall, New cfServiceCall(Me))
        AddRSS(o.Warehouse, New cfWarehouse(Me))
        AddRSS(o.Statuses, New cfStatuses(Me))
        AddRSS(o.Details, New cfDetails(Me))
        AddRSS(o.Malfunction, New cfMalfunction(Me))
        AddRSS(o.Resolution, New cfResolution(Me))
        AddRSS(o.Survey, New cfSurvey(Me))
        AddRSS(o.Repair, New cfRepair(Me))
        AddRSS(o.Time, New cfTime(Me))
        AddRSS(o.Parts, New cfParts(Me))
        AddRSS(o.Signature, New cfSignature(Me))
        AddRSS(o.Answers, New cfAnswers(Me))
        AddRSS(o.Flags, New cfFlags(Me))
        AddRSS(o.Actions, New cfActions(Me))
        AddRSS(o.Cancel, New cfCancel(Me))
        AddRSS(o.DayEnd, New cfDayEnd(Me))
...
#Region "PDA Data Event Handlers"
    ...
    Overrides Sub hNewData(ByVal EventIndex As Integer, ByVal o As cfOnBoardData.PDAData)
        ...
        If NewEvent(EventIndex) Then
            Select Case o.Name
                Case "ServiceCall"
                    ...
                    End If
                    Dim mySound As New Sound(Get_app_path() & "\sounds\alarm.wav")
                    mySound.Play()
    ...
    Overrides Sub hWarning(ByVal EventIndex As Integer, ByVal o As cfOnBoardData.PDAData, ByVal SubName As String, ByVal Message As String, ByVal infoOnly As Boolean)
    ...
    Overrides Sub hFormRedraw(ByVal EventIndex As Integer, ByVal o As cfOnBoardData.PDAData)
    ...
    Overrides Sub hSigSaved(ByVal EventIndex As Integer, ByVal o As cfOnBoardData.PDAData, ByVal Ordinal As Integer)
...
#Region "Toolbar Commands"
    ...
    Private Sub QuitToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles QuitToolStripMenuItem.Click
        ...
        Else
            ...
            ' Set the panels
            Me.SyncToolStripMenuItem.Enabled = True
...
#Region "Private Functions"
    ...
    Private Sub AppForm_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        ...
        With Me.InnerArea
            .Left = 1
            .Width = Me.Width - 10
            .Top = 0 'Me.MainStrip1.Top + Me.MenuStrip1.Height
...
#Region "Status bar messages"
    ...
    Public Sub SetWarningText()
        If Not IsNothing(_Warnings) Then
            Status.Text = _Warnings(1, UBound(_Warnings, 2))
