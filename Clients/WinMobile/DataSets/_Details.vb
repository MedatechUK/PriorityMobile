...
#Region "Initialisation"
    ...
    Public Sub New(Optional ByRef App As cfOnBoardData.BaseForm = Nothing)
        ...
        With Me
            .Name = "Details"
            .ConQuery = "SELECT * FROM V_SVCCALL_DETAILS WHERE USERLOGIN = '" & CallerApp.mySettings.Username & "' "
            .Column(0) = "DOCNO"
            .Column(1) = "TEXT"
        End With
...
#Region "Must Override Subs"
    ...
    Public Overrides Sub ChangeSettings()
        Me.ConQuery = "SELECT * FROM V_SVCCALL_DETAILS WHERE USERLOGIN = '" & CallerApp.mySettings.Username & "' "
    End Sub
            ...
            If Not IsNothing(tempArray) Then
                For i As Integer = 0 To UBound(tempArray, 2)
                    If ar.InArray(thisArray, 0, tempArray(0, i)) = -1 Then
                        ch = True
                        Dim n As Integer = CallerApp.rss(o.Details).NewRecord
