...
#Region "Initialisation"
    ...
    Public Sub New(Optional ByRef App As cfOnBoardData.BaseForm = Nothing)
        ...
        With Me
            .Name = "Warehouse"
            .ConQuery = "SELECT * FROM V_SVCCALL_WARHS WHERE WARHSNAME = '" & CallerApp.mySettings.Warehouse & "' "
            .Column(0) = "PARTNAME"
            .Column(1) = "PARTDES"
            .Column(2) = "QTY"
            .Column(3) = "PRICE"
...
#Region "Must Override Subs"
    ...
    Public Overrides Sub ChangeSettings()
        Me.ConQuery = "SELECT * FROM V_SVCCALL_WARHS WHERE WARHSNAME = '" & CallerApp.mySettings.Warehouse & "' "
    End Sub
        ...
        Try
            ...
            If Not IsNothing(tempArray) Then
                For i As Integer = 0 To UBound(tempArray, 2)
                    If Not IsNothing(CallerApp.rss(o.Parts).thisArray) Then
                        Dim used(,) As String = ar.SubSet(CallerApp.rss(o.Parts).thisArray, 2, tempArray(0, i))
                        Dim c As Integer = 0
