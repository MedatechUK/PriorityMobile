        ...
        Try
            If Not qing Then
                ...
                Me.SafeLog( _
                    ...
                    LogEntryType.Information, ntEvtlog.EvtLogVerbosity.VeryVerbose _
                )
    ...
    Private Sub doq()
        ...
        While Data.Count > 0 And Not (_quit)
            Try
                ...
                Dim dt As ntDictionaryLib.qItem = Data.Item(key)
                Dim fn As String = dt.Filename
                Dim hResult As Boolean = False

                Select Case LCase(dt.SOAPProc)
                    Case "savesignature"
                        Dim p As New Priority.SerialData
                        With p
                            If .FromFile(fn) Then
