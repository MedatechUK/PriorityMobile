...
CREATE TABLE [dbo].[hosts](
	...
	[PageMaster] [varchar](max) NULL,
	[PageTitle] [varchar](max) NULL,
	[password] [varchar](max) NULL,
	[redirecturl] [varchar](max) NULL,
	[redirectuser] [varchar](max) NULL,
	[redirectpass] [varchar](max) NULL,
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Activity]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'-- =============================================
-- Author:		<Author,,Name>
...
BEGIN
	...
	convert(datetime, LastActivityDate, 103) as LastActivityDate
	from dbo.aspnet_Users, dbo.aspnet_Membership
	where dbo.aspnet_Users.UserId = dbo.aspnet_Membership.UserId
	and LastActivityDate > @fromdate
