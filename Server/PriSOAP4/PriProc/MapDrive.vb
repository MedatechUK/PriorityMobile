...
Module MapDrive
    ...
    Public Function GetNetworkDrive(ByVal UNCPath As String) As NetworkDrive
        If UNCPath.Length = 0 Then Return Nothing
        If Not UNCPath.Substring(0, 2) = "\\" Then Return Nothing
        For Each d As DriveInfo In DriveInfo.GetDrives
            If d.DriveType = IO.DriveType.Network Then
                Dim UNCName As String = Space(160)
                If WNetGetConnection(d.Name.Substring(0, 2), UNCName, UNCName.Length) = 0 Then
    ...
    Public Sub MapDriveLetter(ByVal DriveLetter As String, ByVal UNCPath As String, ByRef LogBuilder As Builder)
        ...
        Dim nDri As List(Of NetworkDrive) = NetworkDrives()
        ...
        With myProcess
            ...
            With sIn
                ...
                For Each nDrive As NetworkDrive In nDri
            ...
            Dim er As String = sErr.ReadToEnd.Replace("The handle is invalid.", "").Replace(Chr(13), "").Replace(Chr(10), "")
            If er.Length > 0 Then
