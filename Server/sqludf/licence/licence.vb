...
Public Class licence
    ...
    <SqlFunction(DataAccess:=DataAccessKind.Read)> _
        Public Shared Function Activated(ByVal EntityID As Integer) As Integer
        Using conn As New SqlConnection("context connection=true")
            conn.Open()
            If String.Compare(ModuleName(EntityID, conn).Substring(1, 6), "emerge", True) = 0 Then
                If Validate( _
    ...
    Private Class ch
        Private Numbers = "1234567890ABCDEFGHIJKLMNOPQRTSUVWXYZ"
