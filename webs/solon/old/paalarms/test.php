...
$page_query = mysql_query("select * from SHOP1_content where id='1'");
...
<?php echo writeShoppingCart(); ?>
  ...
  <?php
	...
	echo("<div class='xdelivery'><p><strong>Christmas last order dates</strong>: 19th December (standard delivery), 21st December (next day delivery). Normal service resumes 2nd January 2008.
</p></div>");
