...
<?php echo writeShoppingCart(); ?>
  ...
  <?php 
	echo("$site_notice");
	?>
    <h2>Personal Alarms - Now Protect Your Loved Ones For Less!</h2>
	<p><strong>All our personal alarms come fitted with batteries and are covered by our 1 year guarantee.</strong></p>
<p><strong>Our Postage &amp; Packaging costs have been reduced to save you even more money!<br />
</strong></p>
	<?php
	...
	while ($result = mysql_fetch_array($query))
		...
		if($result[price_was])
			...
			echo("<p class='now'>Sale Price &pound;$result[price]</p>");
			}
		else
			{
		...
		if ($result[stock] == "NO")
			...
			{
			echo('<input name="submit" type="image" value="Submit" src="assets/images/add_to_basket.gif" alt="Add to Basket" /></form>');
			}
