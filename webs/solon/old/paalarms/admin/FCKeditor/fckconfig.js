...
FCKConfig.ToolbarSets["Pete"] = 
[
	['FontFormat','TextColor','BGColor','Bold','Italic','SpecialChar'],
	['OrderedList','UnorderedList','-','Link','Unlink','-','PasteText','Image'],
	['FitWindow','Source','Undo','Redo']	
] ;

FCKConfig.ToolbarSets["summary"] = 
[
	['Bold','OrderedList','UnorderedList','-','Link','Unlink','-','PasteText','Source','Undo','Redo']
] ;
