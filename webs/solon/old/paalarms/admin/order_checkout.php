    ...
    <form method="post" action="order_checkout.php?check=yes">
      ...
      <p>
        ...
        <select name="deliverymethod">
          ...
          <option value="3.95" <?php if ($_POST[deliverymethod] == "3.95") { echo ("selected='selected'"); } ?>>Royal Mail 1st Class (&#163;3.95)</option>
          <option value="8.95" <?php if ($_POST[deliverymethod] == "8.95") { echo ("selected='selected'"); } ?>>Royal Mail Next Day (&#163;8.95)</option>
