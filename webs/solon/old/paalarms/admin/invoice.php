...
<title>Redline Security Invoice - Order Number #: <?php echo ($result[order_number]); ?> </title>
<link rel="stylesheet" href="../assets/css/invoice.css" type="text/css" media="screen" />
...
<!-- body_text //-->
<div class="print_page"><a href="#" id="printpage" onClick="printPage()" title="Print a paper friendly version of this page">Print Invoice</a></div>
<table width="95%" border="0" align="center" cellpadding="2" cellspacing="0">
  <tr align="left">
    <td class="titleHeading"><img src="images/pixel_trans.gif" border="0" alt="" width="1" height="25"></td>
  </tr>
  <tr>
    <td><table border="0" align="center" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          <td><table border="0" align="center" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td style="color:#acd700; font-size:80%"><small>Redline Security<br>
                  Unit 40<br>
                  Manor Industrial Estate<br>
                  Flint<br>
                  Flintshire<br>
                  CH6 5UY</small></td>
                <td class="pageHeading" align="right"><img src="../assets/images/logo.gif" alt="Redline Security" width="300" height="47"/></td>
              </tr>
              <tr align="left">
  ...
  <tr>
    <td align="left" class="main"><table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <td><small><b>Order Number:</b> <?php echo ($result[order_number]); ?></small></td>
        </tr>
        <tr>
              ...
              <tr>
                <td align="center" valign="top"><table align="center" width="100%" border="0" cellspacing="0" cellpadding="2">
                    <tr style="border: 1px solid #999;">
                      <td background="../assets/images/product_h3_bg.gif" style="font-size: 90%"><b>SOLD TO:</b></td>
                    </tr>
              ...
              <tr>
                <td align="center" valign="top"><table align="center" width="100%" border="0" cellspacing="0" cellpadding="2">
                    <tr class="dataTableHeadingRow">
                      <td background="../assets/images/product_h3_bg.gif" style="font-size: 90%"><b>DELIVERED TO:</b></td>
                    </tr>
                    <tr class="dataTableRow">
  ...
  <tr>
    <td id="footer"><h3 style="font-size: 120%; padding:10px 0 0 10px;">Terms and Conditions</h3>
      <font color="#999999"><p style="font-size:70%">All customers wishing to return a product must first contact our customer services on 01745 828449 or email <a href="mailto:paa-returns@redlinesecurity.co.uk" style="color: #4c7a08;font-weight: bold;">paa-returns@redlinesecurity.co.uk</a>. Please include your order number and a reason for why you want to return the item (for example if the wrong item was delivered, or an incorrect quantity). You will then be sent out a returns pack.</p></font>
      ...
      <p style="font-size:70%">Please ensure that you have read and understood our terms and conditions, which can be found on our website at <a href="http://www.personal-attack-alarms.net/terms_and_conditions.php" style="color: #4c7a08;font-weight: bold;">www.personal-attack-alarms.net/terms_and_conditions.php</a></p>
