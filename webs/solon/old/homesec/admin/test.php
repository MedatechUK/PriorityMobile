...
<script type="text/javascript" src="../assets/scripts/AutoSuggest2.js" charset="utf-8"></script>

<link rel="stylesheet" href="../assets/css/admin.css" type="text/css" media="screen" charset="utf-8" />
...
<h3>What's new in 2.1.3? <small>2007-07-19</small></h3>

<ul>
	<li>Identitfied and fixed bug that caused "No results!" to appear every other character with longer lists</li>
	<li>Added the <em>required</em> <code>maxresults</code> option</li>
</ul>


<h3>What's new in 2.1.2? <small>2007-07-07</small></h3>

<ul>
	<li>Smaller file size (under 9k)</li>
	<li>Uses <code>encodeURIComponent</code> instead of <code>encodeURI</code></li>
	<li><code>bsn</code> namespace is set as default - uses <code>new bsn.Autosuggest(...</code> instead of <code>new Autosuggest(...</code>. This avoids conflicts with other libraries (e.g. prototype) out of the box.</li>
...
<ul>
	<li>Smaller file size (under 10k)</li>
	<li><code>script</code> variable can now be a function</li>
	<li>'shownoresults' bug fix</li>
</ul>
...
<ul>
	<li><code>bsn.AutoSuggest_2.1.3_comp.js</code></li>
</ul>

<p><a href="http://www.brandspankingnew.net/download.php?file=autosuggest_v2.1.3.zip" title="download the zip archive"><strong>Get the files here!</strong></a></p>
...
var as = new bsn.AutoSuggest('idOfTextfield', options);</code>
</pre>
...
<pre><code>script: function (input) { return "test.php?input="+input+"&amp;testid="+document.getElementById('testid').value; }</code></pre>

<p>This allows you to build the script URL dynamically, passing variable data from somewhere else in your document (eg. from another field, as in the example above). If the script returns <code>false</code>, no AJAX request will be made.
...
<script type="text/javascript">
	var options = {
		script:"../assets/ajax/test.php?json=true&limit=6&",
		varname:"input",
		json:true,
		shownoresults:false,
		maxresults:6,
