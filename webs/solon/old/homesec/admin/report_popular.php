...
echo("<div id='admin'>
	...
	while ($result = mysql_fetch_array($query))
		...
		$last_q = mysql_query("select * from $report_popular_table where product = '$key' order by id desc limit 1");
		...
		if($num == "1")
				...
				echo("<tr$class><td>$result[name]</td><td>$result[code]</td><td>$val</td><td>$date</td></tr>");
		}
