<?php
$myFile 				= 	"../products/".$page_name_formatted.".php";
$myPage					=	$page_name_formatted.".php";
...
<?php
\$query = mysql_query(\"select * from \$product_table where id = '$_GET[edit]' and product_active != 'NO'\");
...
// Sub products
\$att_query = mysql_query(\"select * from \$product_table where sub = '$_GET[edit]' and product_active != 'NO'\");
\$num_rows = mysql_num_rows(\$att_query);
...
//==========================================================================
		...
		\$process = mysql_query(\"insert into \$report_popular_table (product, ip, visit) VALUES ('$_GET[edit]', '\$ip', '\$date_added')\");
		}
...
";
			...
			fclose($fh);
			echo("<p><small>The page <a href='$myFile'>$myFile</a> has been created</small></p>");
