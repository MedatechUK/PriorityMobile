...
$ordernum_query=mysql_query("select order_number2 from $orders_table order by id desc limit 1");
...
$process=mysql_query("INSERT INTO $orders_table (order_number, cartinfo, orderinfo, total_cost, email, date, streference, stauthcode, stresult, billing_address, delivery_address, cartdetail, order_number2, postage) VALUES ('$_POST[orderref]', '$_POST[cartinfo]', '$_POST[orderinfo]', '$_POST[inputamount]', '$_POST[email]', '$date_added', '$_POST[payment]', '$_POST[payment]', '$_POST[payment]', '$billing_details', '$delivery_details', '$_POST[cartdetail]', '$order_number', '$_POST[postage]')"); 
...
foreach ($contents as $id=>$qty) {
			...
			$pr_query = mysql_query("SELECT * FROM $product_table WHERE id = ".$id."");
			...
			$report_process = mysql_query("INSERT INTO $report_products_table (product_id, price, date_added, order_id, qty) VALUES ('$id', '$product_price', '$date_added', '$order_number', '$qty')"); 		
			}			
} 
