...
<?php
$query = mysql_query("select * from $product_table where id = '139' and product_active != 'NO'");
...
// Sub products
$att_query = mysql_query("select * from $product_table where sub = '139' and product_active != 'NO'");
$num_rows = mysql_num_rows($att_query);
...
//==========================================================================
		...
		$process = mysql_query("insert into $report_popular_table (product, ip, visit) VALUES ('139', '$ip', '$date_added')");
		}
