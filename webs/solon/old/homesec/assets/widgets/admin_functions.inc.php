...
function adminCart() {
	...
	if ($cart) {
		...
		if ($_POST[discount] == "0.00")
			{
			$discount_val = "0.00";
			$output[] = '<tr class="total"><td colspan="5">Discount: <strong>&pound;<input type="text" name="discount" value="'.$discount_val.'" size="5" maxlength="7" /></strong></td></tr>';
			}
		else	
			{
			$discount_val = $_POST[discount];
			$output[] = '<tr class="total"><td colspan="5">Discount: <strong>&pound;<input type="text" name="discount" value="'.$discount_val.'" size="5" maxlength="5" /></strong></td></tr>';
		...
		$output[] = '
		<p class="buttons"><input name="submit" type="image" value="Submit" src="../assets/images/buttons/update.jpg" alt="Update Basket" /> <a href="order_checkout.php" title="Click here to proceed to the checkout"><img src="../assets/images/buttons/continue.jpg" border="0"/></a></p>';
		$output[] = '</form>';
