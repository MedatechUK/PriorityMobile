...
<?php
$query = mysql_query("select * from $product_table where id = '$_GET[product_id]' and product_active != 'NO'");
	while ($result = mysql_fetch_array($query))
		{
?>
<title><?php echo ("$result[name] by $site_name"); ?></title>
  ...
  <div id="main_content">
   <?php 
	...
	while ($result = mysql_fetch_array($query))
		...
		echo("<p class='tell_a_friend'><a href='tell_a_friend.php' title='Click here to tell a friend about this product'><img src='/assets/images/buttons/tell_a_friend.gif' alt='Tell a friend'/></a></p></div>");
...
// Sub products
$att_query = mysql_query("select * from $product_table where sub = '$_GET[product_id]' and product_active != 'NO'");
$num_rows = mysql_num_rows($att_query);
...
//==========================================================================
		...
		$process = mysql_query("insert into $report_popular_table (product, ip, visit) VALUES ('$_GET[product_id]', '$ip', '$date_added')");
