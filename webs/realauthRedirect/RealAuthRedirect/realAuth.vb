...
Public Class realAuth : Inherits BaseRedirect
    ...
    Public Sub New(ByVal MerchantName As String, ByVal Account As String, ByVal OrderID As String, ByVal Amount As String, ByVal Currency As String, ByVal Password As String)
        With PostValues
