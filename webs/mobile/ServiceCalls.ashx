            ...
            Try
                ...
                Using Connection As New SqlConnection(ConnectionString)
                    ...
                    ret.CommandText = String.Format( _
                        ...
                        "      ( " & _
                        "		SELECT [CallNumber] AS {0}@CallNumber{0} " & _
                        ...
                        "			   FROM [dbo].[v_SvcCall] " & _
                        "			   where [CustomerNum] = c.[CustomerNum] " & _
                        "              ORDER BY [CURDATE] DESC " & _
                        "			   for XML PATH('Call'),type  " & _
                        "		  ) " & _
                        "  FROM [dbo].[v_SvcCall] as c " & _
                        "  GROUP BY [CustomerNum], [CustomerName] " & _
                        "  for XML PATH('Customer'), ROOT('ServiceCalls')" _
                        , Chr(34) _
                    )
