...
#Region "Direct Activations"
    ...
    Public Overrides Sub SetNumber(ByVal MyValue As Double)
        ...
        With thisForm
            ...
            AddOrderItem(thisForm, .FormData.SelectSingleNode(thisForm.Parent.Parent.thisxPath).ParentNode.ParentNode, .CurrentRow("name"), .CurrentRow("barcode"), .CurrentRow("des"), MyValue.ToString, prepay)
            '.SetTopForm(0)
