    ...
    Private Sub hCalc()
        ...
        With thisForm
            If .CurrentRow("serialpart") = "Y" Then
                ...
                If String.Compare(.CurrentRow("serial").ToString, "0", True) = 0 Then
                    txtserial.Text = ""
                    txtserial.Enabled = True
                    dlg.FocusContolName = "txtSerialNumber"
                Else
                    txtserial.Text = .CurrentRow("serial").ToString
    ...
    Private Sub CloseAddDialog(ByVal frmDialog As PriorityMobile.UserDialog)
        With thisForm
            If frmDialog.Result = DialogResult.OK Then
                Dim part As String = .CurrentRow("name")
                ...
                Else
                    ...
                    .CurrentRow("location") = location.Text
                End If
