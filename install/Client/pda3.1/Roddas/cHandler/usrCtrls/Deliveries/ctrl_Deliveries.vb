...
#Region "Direct Activations"
    ...
    Public Overrides Sub DirectActivations(ByRef ToolBar As daToolbar)
        With ToolBar
            ...
            .Add(AddressOf hCloseDelivery, "delete.BMP", Not ListSort1.SelectedIndex = -1)
        End With
    End Sub
    ...
    Public Sub PrintInvoice(ByVal dv As XmlNode)
        ...
        Dim largeFont As New PrinterFont(30, 0, 4)
        Dim smallFont As New PrinterFont(35, 0, 3)
        Dim smallerFont As New PrinterFont(35, 0, 2)
    ...
    Private Sub hCloseDelivery()
        ...
        Dim dlg As dlgCloseDelivery = preClose(thisForm, thisForm.FormData.SelectSingleNode(thisForm.thisxPath), ex)
