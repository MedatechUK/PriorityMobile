...
#Region "Main View Event Handlers"
    ...
    Private Sub hLoadiView(ByVal ControlName As String, ByRef view As iView, ByRef thisForm As xForm) Handles MainView.LoadiView
        ...
        With ue
            If Not IsNothing(.CustomHandler) Then
                Try
                    Dim oType As System.Type = .CustomHandler.GetType(String.Format("pdaHandler.ctrl_{0}", ControlName.Replace(".vb", "")))
    ...
    Private Sub hSyncEvent(ByVal NodeType As String, ByVal EventType As eSyncEventType, ByRef DataXML As OfflineXML) Handles MainView.SyncEvent
