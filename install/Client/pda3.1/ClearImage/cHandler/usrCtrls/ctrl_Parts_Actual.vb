...
#Region "Direct Activations"
    ...
    Public Overrides Sub DirectActivations(ByRef ToolBar As daToolbar)
        ...
        If ListSort1.Items.Count = 0 Then
            vis = False
        End If
        If ListSort1.Items.Count = 1 Then
            If ListSort1.Value("qty", 0) = 0 And ListSort1.Value("name", 0) = "" Then
                vis = False
            End If
        End If
        With ToolBar
            .Add(AddressOf hCalc, "edit.BMP", (vis))
            .Add(AddressOf hDeleteActual, "delete.BMP", (vis))
        End With
    End Sub
    ...
    Public Overrides Sub SetNumber(ByRef cSetting As calcSetting)
        ...
        With thisForm
            ...
            If .CurrentRow("fromstock") = "Y" Then
                ...
                If Not IsNothing(whNode) Then
                    Dim DIF As Integer = cSetting.DNUM - CInt(.CurrentRow("qty"))
    ...
    Private Sub hCalc()
        ...
        With thisForm
            ...
            t = .CurrentRow("serial")
            t = .CurrentRow("qty")
            t = .CurrentRow("fromstock")
            t = .CurrentRow("planned")
            t = .CurrentRow("serialpart")
            t = .CurrentRow("location")
            t = .CurrentRow("trans")
            ...
            Else
                ...
                If Not IsNothing(whNode) Then
                    thisForm.Calc(New calcSetting(CInt(thisForm.CurrentRow("qty")))) '+ CInt(whNode.SelectSingleNode("qty").InnerText)))
                Else
                    thisForm.Calc(New calcSetting(CInt(thisForm.CurrentRow("qty"))))
                End If
