...
#Region "Local Variables"
    ...
    Public ar As New Priority.MyArray
    Public p As New Priority.Load
    Public sd As New Priority.SerialData
    ...
    Public _App As PDAOnBoardData.BaseForm
...
#Region "Private Functions"
    ...
    Private Function MakeLDFN() As String
        ...
        While File.Exists(_PostPath & Split(fn, ".")(0) & ".txt")
            fn = Path.GetRandomFileName()
        End While

        Return _PostPath & Split(fn, ".")(0) & ".txt"
...
#Region "Threads"
    ...
    Private Sub seekThread()
        ...
        Try
            ...
            Sucsess = Caller.ConWebService(Data)
            Do While Not Sucsess
                Caller.confail(Cancel)
    ...
    Private Sub seekSig()
        ...
        Try
            ...
            While UBound(toLoad) > -1
                ...
                Sucsess = Caller.SaveSig(sData, ret)
                Do While Not Sucsess
                    Caller.confail(Cancel)
                    If Cancel Or appExit Then
                        Exit Do
