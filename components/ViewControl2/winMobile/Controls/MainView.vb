...
#Region "Public Events"
    ...
    Public Event SyncEvent(ByVal NodeType As String, ByVal EventType As PrioritySFDC.eSyncEventType, ByRef DataXML As PrioritySFDC.OfflineXML)
...
#Region "Initialisation and finalisation"
    ...
    Public Sub LoadUE(ByRef ue As UserEnv)
        _ue = ue
    End Sub
...
#Region "Draw Interface elements"
    ...
    Public Sub StartCalc(ByRef cSetting As calcSetting) Handles xf.StartCalc
        With Me
            With .ContentPanel
                With .Controls
                    .Clear()
                    Dim C As New calc(cSetting)
