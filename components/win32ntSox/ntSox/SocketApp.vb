...
#Region "overridable subs"
    ...
    Public Overridable Sub OnCommand(ByVal CmdStr As String, ByVal Args() As String)

    End Sub

    Public Overridable Sub OnStream(ByVal StreamData As String)
...
#Region "Send data to Sender"
    ...
    Public Function SendFormat(ByVal StrVal As String, ByVal ParamArray Args() As String) As Boolean
        Return Send(String.Format(StrVal, Args))
    End Function

    Public Function Send(ByVal StrVal As String, Optional ByVal LineEnd As String = vbCrLf) As Boolean
        ...
        If IsConnected() Then
            ...
            Try
                bteSend = Encoding.ASCII.GetBytes(StrVal & LineEnd)
...
#Region "Buffer"
    ...
    Private Sub ReadBuffer(ByRef buffer() As Byte, ByVal intByte As Integer)
        Try
            _buffer += Encoding.ASCII.GetString(buffer, 0, intByte).Replace(vbCrLf, Chr(13)).Replace(ChrW(10), Chr(13))
            OnStream(Encoding.ASCII.GetString(buffer, 0, intByte).Replace(vbCrLf, Chr(13)).Replace(ChrW(10), Chr(13)))
