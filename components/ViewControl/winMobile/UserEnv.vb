    ...
    Public Sub New()
        ...
        Do
            ...
            Catch
                download = False
                retry = MsgBox( _
                    String.Format("Cannot connect to provisioning service.") _
                    , MsgBoxStyle.RetryCancel, "Connection" _
                ) = MsgBoxResult.Retry
            End Try
        Loop Until download Or (Not retry)
        If Not download Then Throw New Exception("Cannot connect to provisioning service.")
        ...
        If IsNothing(pnode) Then Throw New Exception("Provisioning info not found.")
